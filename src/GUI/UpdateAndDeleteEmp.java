...
public class UpdateAndDeleteEmp extends javax.swing.JFrame {
 // 👇 Observer Pattern Code Starts Here
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String typeofwork=jTextField15.getText();
        ...
        try{
            ...
            String sql="update employee set name='"+name+"',mobilenumber='"+mobilenumber+"',email='"+email+"',gender='"+gender+"',age='"+age+"',address='"+address+"',startday='"+startday+"',typeofwork='"+typeofwork+"',salary='"+salary+"',medical='"+medicalcomments+"'where id='"+id+"'";
            //ResultSet rs=stm.executeQuery(sql);
            if(jTextField1.getText().length()<=0||jTextField2.getText().length()<=0||jTextField3.getText().length()<=0||jTextField16.getText().length()<=0||jTextField12.getText().length()<=0||jTextField13.getText().length()<=0||jTextField8.getText().length()<=0||jTextField15.getText().length()<=0||jTextField14.getText().length()<=0||jTextField9.getText().length()<=0)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/gymdata","root","");
            Statement stm=con.createStatement();
            ResultSet rs=stm.executeQuery("select *from employee where id='"+id+"'");
            while(rs.next())
            {
                checkid=1;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int closebutton=JOptionPane.showConfirmDialog(null,"Delete this member ?","Select",JOptionPane.YES_NO_OPTION);
